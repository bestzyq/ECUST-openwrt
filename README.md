# ECUST-openwrt
<a href='https://github.com/bestzyq/ECUST-openwrt'><img alt="GitHub stars" src="https://img.shields.io/github/stars/bestzyq/ECUST-openwrt?logo=github"></a>
...
## 使用network
直接修改 `/etc/config/network` 文件，在下方添加 `network` 或者 `network_onlyschool` 内容
